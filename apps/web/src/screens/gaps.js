...
const GROUPS = [
  ...
  },
  {
    ...
    // taken yet, or a decision nobody has made. SHOP-CAPTURE-001 (DEC-038) added the shop's own
    // measurements to it -- machines and cycles, trip costs, Sổ thu chi, margin when complete.
    lede:
      "Màn Báo cáo có số của chủ: đơn, đúng hẹn theo mốc nội bộ, giặt lại, khiếu nại, tiền đã thu " +
      "và bồi hoàn — mỗi số kèm tử số, mẫu số, khoảng ngày và phiên bản truy vấn — cùng số tiệm tự " +
      "đo: mẻ có ghi máy, phút mỗi mẻ, chi phí giao mỗi đơn, chi theo mục và biên của tháng khi đủ " +
      "số liệu. Các mục dưới đây vẫn thiếu vì cần số đo thật hoặc một quyết định chưa ai đưa ra.",
    entries: [
