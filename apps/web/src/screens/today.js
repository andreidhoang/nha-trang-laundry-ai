 ...
 * deposits and B2B accounts are outside it — DEC-010 (resolved) deliberately defers them. The one
 * refund that exists — a paid order cancelled under DEC-024 with the whole amount handed back — is
 * shown beside the takings with the drawer's net movement, on the day it happened
 * (`collected-today-v2`). The headline is still the gross takings. An owner who reads this as
