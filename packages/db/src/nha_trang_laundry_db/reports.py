...
**What the shop measured** (`SHOP-CAPTURE-001`, `DEC-038`; since `report-v3`):
...
def _period(
    ...
    figures = (
        ...
        # Counts, not rates (round-6 filmed review; since `report-v2`, kept in `report-v3`). v1
        # divided the orders that completed or were cancelled in the window by the orders
        # *created* in it: two different populations, so "37 %" read as a share of the week's
        # orders and could pass 100 %.
        ReportFigure(
