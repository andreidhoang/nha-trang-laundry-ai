...
| `AGENT-001` | AGENT_SHADOW | Isolated OpenClaw Concierge, Tool Facade and evals | OPERATIONS-001 | In progress — local P0 preflights include timeout, IDOR, approval edit and manual/worker exclusion; kill-switch, integrated runtime and provider evidence pending |
